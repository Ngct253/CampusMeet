...
Tài liệu này trả lời “file này dùng để làm gì?” và “tôi nên bắt đầu code ở đâu?”. Trước khi sửa contract hoặc infrastructure, đọc [SRS](CampusMeet-SRS.md), [kiến trúc](architecture.md), [API contract](api-contract.md) và [mô hình dữ liệu DynamoDB](dynamodb-data-model.md).
...
Chi tiết key/access pattern nằm duy nhất tại [mô hình dữ liệu DynamoDB](dynamodb-data-model.md).
...
## 7. Luồng upload, live transcript và AI

Chi tiết kỹ thuật nằm tại [Thiết kế kỹ thuật upload/live transcript/AI](thiet-ke-ky-thuat-upload-live-transcript-ai.md). Luồng tổng quát:
...
| Script                       | Tính chất                        |
| ---------------------------- | -------------------------------- |
| `verify-data-foundation.ps1` | Kiểm tra chỉ đọc 5 bảng DynamoDB |
...
| Upload/live transcript/AI | Kế hoạch nhóm, thiết kế kỹ thuật AI và data model meeting/ai-work | Các module attachment/transcript/AI và worker theo đúng người phụ trách |
